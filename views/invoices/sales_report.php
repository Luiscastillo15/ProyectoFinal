...
<head>
    ...
    <title>Reporte de Ventas - Sistema AguaZero C.A.</title>
    <style>
        @page {
            size: A4;
            margin: 15mm;
...
<body>
    ...
    <div class="no-print">
        ...
        <a href="index.php?action=reportes&method=salesByDate" class="btn btn-secondary">⬅️ Volver</a>
    </div>
    ...
    <div class="report-container">
        ...
        <div class="report-header">
            ...
            <div class="report-title">📈 REPORTE DE VENTAS POR FECHA</div>
